package com.iabot.api.views.dashboard

import kotlinx.serialization.Serializable
import com.iabot.common.utils.ServerImports
import utils.IAColor
...
fun Collection<serverManager.Key>.getValue() = this.sumByDouble { it.value }
fun Collection<serverManager.Key>.getP() = ServerImports.getPFromValue(this.getValue())